...
model = pickle.load(open(r'LR for blood report_pickle', 'rb'))
...
def home():
    ...
    if form.validate_on_submit():
        ...
        if file_name.endswith('.jpg'):
            ...
            img=Image.open(r"static/files/"+file_name)
            ...
            images = convert_from_path(r"static/files/"+file_name, 500,poppler_path=r"C:/Program Files/poppler-0.68.0/bin")
